...
# for stock in stocks:
#     print(stock.get('price')) # 값이 없으면 None 처리
    # print(stock['price']) 오류가남

for stock in stocks:
    print(stock.get('price', '비상장 주식입니다.')) # 예외발생시 처리

'''
get의 기능 get('1', '2')
보통 '1'을 출력하지만 값이없다면 None을 출력함
'2' 를 입력해두면 1이 None일때 '2'을 출력해줌
'''
